...
import { RoleService } from 'app/entities/rostermicrov2/role/service/role.service';
...
describe('ResourceRoles Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Role query and add missing value', () => {
      ...
      const role: IRole = { id: 91 };
      resourceRoles.role = role;

      const roleCollection: IRole[] = [{ id: 24013 }];
    ...
    it('Should call Resource query and add missing value', () => {
      const resourceRoles: IResourceRoles = { id: 456 };
      const resource: IResource = { id: 16877 };
      resourceRoles.resource = resource;

      const resourceCollection: IResource[] = [{ id: 15896 }];
    ...
    it('Should update editForm', () => {
      const resourceRoles: IResourceRoles = { id: 456 };
      const role: IRole = { id: 11468 };
      resourceRoles.role = role;
      const resource: IResource = { id: 22399 };
      resourceRoles.resource = resource;
