...
import { ShiftTypeService } from 'app/entities/rostermicrov2/shift-type/service/shift-type.service';
...
describe('RefCalendar Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call ShiftType query and add missing value', () => {
      ...
      const shiftType: IShiftType = { id: 20412 };
      refCalendar.shiftType = shiftType;

      const shiftTypeCollection: IShiftType[] = [{ id: 12294 }];
    ...
    it('Should update editForm', () => {
      const refCalendar: IRefCalendar = { id: 456 };
      const shiftType: IShiftType = { id: 7368 };
      refCalendar.shiftType = shiftType;
