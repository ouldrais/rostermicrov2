...
import { ShiftService } from 'app/entities/rostermicrov2/shift/service/shift.service';
import { ITask } from 'app/entities/rostermicrov2/task/task.model';
import { TaskService } from 'app/entities/rostermicrov2/task/service/task.service';
import { IPosition } from 'app/entities/rostermicrov2/position/position.model';
import { PositionService } from 'app/entities/rostermicrov2/position/service/position.service';
import { IDepartment } from 'app/entities/rostermicrov2/department/department.model';
import { DepartmentService } from 'app/entities/rostermicrov2/department/service/department.service';
...
describe('ShiftDemand Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Shift query and add missing value', () => {
      ...
      const shift: IShift = { id: 27997 };
      shiftDemand.shift = shift;

      const shiftCollection: IShift[] = [{ id: 30440 }];
    ...
    it('Should call Task query and add missing value', () => {
      const shiftDemand: IShiftDemand = { id: 456 };
      const task: ITask = { id: 17303 };
      shiftDemand.task = task;

      const taskCollection: ITask[] = [{ id: 32695 }];
    ...
    it('Should call Position query and add missing value', () => {
      const shiftDemand: IShiftDemand = { id: 456 };
      const position: IPosition = { id: 15600 };
      shiftDemand.position = position;

      const positionCollection: IPosition[] = [{ id: 5801 }];
    ...
    it('Should call Department query and add missing value', () => {
      const shiftDemand: IShiftDemand = { id: 456 };
      const department: IDepartment = { id: 12631 };
      shiftDemand.department = department;

      const departmentCollection: IDepartment[] = [{ id: 14711 }];
    ...
    it('Should update editForm', () => {
      const shiftDemand: IShiftDemand = { id: 456 };
      const shift: IShift = { id: 8810 };
      shiftDemand.shift = shift;
      const task: ITask = { id: 21712 };
      shiftDemand.task = task;
      const position: IPosition = { id: 16316 };
      shiftDemand.position = position;
      const department: IDepartment = { id: 24445 };
      shiftDemand.department = department;
