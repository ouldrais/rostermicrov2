...
import { TeamService } from 'app/entities/rostermicrov2/team/service/team.service';
...
describe('TeamPlan Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Team query and add missing value', () => {
      ...
      const team: ITeam = { id: 4896 };
      teamPlan.team = team;

      const teamCollection: ITeam[] = [{ id: 9403 }];
    ...
    it('Should call Shift query and add missing value', () => {
      const teamPlan: ITeamPlan = { id: 456 };
      const shift: IShift = { id: 30728 };
      teamPlan.shift = shift;

      const shiftCollection: IShift[] = [{ id: 25279 }];
    ...
    it('Should update editForm', () => {
      const teamPlan: ITeamPlan = { id: 456 };
      const team: ITeam = { id: 13812 };
      teamPlan.team = team;
      const shift: IShift = { id: 27505 };
      teamPlan.shift = shift;
