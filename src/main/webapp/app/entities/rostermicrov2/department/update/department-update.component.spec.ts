...
import { FacilityService } from 'app/entities/rostermicrov2/facility/service/facility.service';
...
describe('Department Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Facility query and add missing value', () => {
      ...
      const facility: IFacility = { id: 6176 };
      department.facility = facility;

      const facilityCollection: IFacility[] = [{ id: 24591 }];
    ...
    it('Should update editForm', () => {
      const department: IDepartment = { id: 456 };
      const facility: IFacility = { id: 15517 };
      department.facility = facility;
