...
import { TrainingService } from 'app/entities/rostermicrov2/training/service/training.service';
...
describe('ResourceTraining Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Resource query and add missing value', () => {
      ...
      const resource: IResource = { id: 10852 };
      resourceTraining.resource = resource;

      const resourceCollection: IResource[] = [{ id: 31840 }];
    ...
    it('Should call Training query and add missing value', () => {
      const resourceTraining: IResourceTraining = { id: 456 };
      const training: ITraining = { id: 25374 };
      resourceTraining.training = training;

      const trainingCollection: ITraining[] = [{ id: 3695 }];
    ...
    it('Should update editForm', () => {
      const resourceTraining: IResourceTraining = { id: 456 };
      const resource: IResource = { id: 28983 };
      resourceTraining.resource = resource;
      const training: ITraining = { id: 30208 };
      resourceTraining.training = training;
