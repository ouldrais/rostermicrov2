...
import { ResourceService } from 'app/entities/rostermicrov2/resource/service/resource.service';
...
describe('ResourcePlan Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Resource query and add missing value', () => {
      ...
      const resource: IResource = { id: 10420 };
      resourcePlan.resource = resource;

      const resourceCollection: IResource[] = [{ id: 26433 }];
    ...
    it('Should call Shift query and add missing value', () => {
      const resourcePlan: IResourcePlan = { id: 456 };
      const shift: IShift = { id: 19131 };
      resourcePlan.shift = shift;

      const shiftCollection: IShift[] = [{ id: 12723 }];
    ...
    it('Should call Position query and add missing value', () => {
      const resourcePlan: IResourcePlan = { id: 456 };
      const position: IPosition = { id: 20276 };
      resourcePlan.position = position;

      const positionCollection: IPosition[] = [{ id: 31545 }];
    ...
    it('Should update editForm', () => {
      const resourcePlan: IResourcePlan = { id: 456 };
      const resource: IResource = { id: 13514 };
      resourcePlan.resource = resource;
      const shift: IShift = { id: 6903 };
      resourcePlan.shift = shift;
      const position: IPosition = { id: 759 };
      resourcePlan.position = position;
